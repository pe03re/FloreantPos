 ...
 * 
 * @hibernate.class table="INVENTORY_WAREHOUSE_ITEM"
 */
...
public abstract class BaseInventoryWarehouseItem implements Comparable, Serializable {
	...
	// public static String PROP_PACKAGE_REPLENISH_LEVEL =
	// "packageReplenishLevel";
	 ...
	 */
	public BaseInventoryWarehouseItem(java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	// return packageReorderLevel == null ? Integer.valueOf(0)
	// : packageReorderLevel;
	// }
	//
	// /**
	...
	// return packageReplenishLevel == null ? Integer.valueOf(0)
	// : packageReplenishLevel;
	// }
	//
	// /**
	...
	// */
	// public void setPackageReplenishLevel(java.lang.Integer
	// packageReplenishLevel) {
	...
	// * the PUNIT_ID value
	// */
	// public void setPackagingUnit(
	// com.floreantpos.model.PackagingUnit packagingUnit) {
	...
	// */
	// public void setItemVendor(com.floreantpos.model.InventoryVendor
	// itemVendor) {

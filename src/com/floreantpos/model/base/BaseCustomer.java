...
public abstract class BaseCustomer implements Comparable, Serializable {
	...
	public static String PROP_ANNI = "anni";
	...
	protected java.lang.String anni;
	...
	/**
	 * Return the value associated with the column: ANNI
	 */
	public java.lang.String getAnni() {
		return anni;
	}

	/**
	 * Set the value related to the column: ANNI
	 * 
	 * @param anni
	 *            the ANNI value
	 */
	public void setAnni(java.lang.String anni) {
		this.anni = anni;
	}

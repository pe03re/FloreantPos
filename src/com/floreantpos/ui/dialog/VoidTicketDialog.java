...
public class VoidTicketDialog extends POSDialog {
				...
				transparentPanel2Layout
						...
						.add(transparentPanel2Layout
								...
								.add(org.jdesktop.layout.GroupLayout.TRAILING,
										transparentPanel2Layout.createSequentialGroup().add(cbVoidReasons, 0, 0, Short.MAX_VALUE).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
												.add(btnNewVoidReason, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 79, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))).addContainerGap()));
				...
				transparentPanel2Layout
						...
						.add(transparentPanel2Layout
								...
								.add(transparentPanel2Layout.createSequentialGroup()
										.add(btnNewVoidReason, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).add(53, 53, 53)))));
	...
	private void btnVoidActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnVoidActionPerformed
		try {
			...
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), ActionHistory.VOID_CHECK,
					com.floreantpos.POSConstants.RECEIPT_REPORT_TICKET_NO_LABEL + ":" + ticket.getId() + "; Total" + ": " + NumberUtil.formatNumber(ticket.getTotalAmount()));
	...
	private void returnInventory(Ticket t) {
